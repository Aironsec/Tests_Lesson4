...
class DetailsActivityTest {
    ...
    fun activityTextView_HasText() {
        scenario.onActivity {
            val totalCountTextView = it.findViewById<TextView>(R.id.totalCountTextView)
            assertEquals(RESULT_0, totalCountTextView.text)
        }
    }
    ...
    fun activityButtonIncrement_IsWorking() {
        scenario.onActivity {
            ...
            assertEquals(RESULT_PLUS_1, totalCountTextView.text)
        }
    }
    ...
    fun activityButtonDecrement_IsWorking() {
        scenario.onActivity {
            ...
            assertEquals(RESULT_MINUS_1, totalCountTextView.text)
        }
    }
    ...
    fun activityCreateIntent_HasCount() {
        ...
        val bundle = intent.extras
        assertEquals(TOTAL_COUNT, bundle?.getInt(DetailsActivity.TOTAL_COUNT_EXTRA, 0))
    }
