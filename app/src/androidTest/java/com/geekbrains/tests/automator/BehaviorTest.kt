...
//            .perform(ViewActions.pressImeActionButton())
    ...
    @Test
    fun test_OpenDetailsScreen_CheckResult() {
        val editText = uiDevice.findObject(By.res(packageName, "searchEditText"))
        val searchButton = uiDevice.findObject(By.res(packageName, "searchButton"))
    ...
    @Test
    fun test_OpenDetailsScreen_CheckIncrement() {
        val toDetails = uiDevice.findObject(By.res(packageName, "toDetailsActivityButton"))
        toDetails.click()
        val changedText =
            uiDevice.wait(
        ...
        val buttonIncrement = uiDevice.findObject(By.res(packageName, "incrementButton"))
        val buttonDecrement = uiDevice.findObject(By.res(packageName, "decrementButton"))
